...
=== "Fire Managers"
    ...
    **Focus Areas:**
    ...
    - [Operational workflows](part-10-workflows/pipelines/)
    
    **Key Models:** FARSITE, FlamMap, IFTDSS
...
=== "Emergency Managers"
    ...
    **Focus Areas:**
    ...
    - [Low-latency data systems](part-04-data/real-time/)
    
    **Key Models:** WRF-Fire, ELMFIRE, FSPro
...
=== "Utilities"
    ...
    **Focus Areas:**
    ...
    - [Grid hardening strategies](part-07-utilities/coordination/)
    
    **Key Tools:** Technosylva, Pyregence, QUIC-Fire
...
=== "Insurance"
    ...
    **Focus Areas:**
    ...
    - [Mitigation credits](part-08-insurance/mitigation/)
    
    **Key Tools:** RMS, AIR, Zest AI, RedZone
...
=== "Researchers"
    ...
    **Focus Areas:**
    ...
    - [Neural operators](part-10-workflows/surrogates/)
...
Not sure which model to use? Our [**Model Selection Guide**](part-01-orientation/quick-reference/#model-chooser) helps you find the right tool for your specific application.

### Latest Updates
- **December 2024**: Marshall Fire digital twin case study
- **November 2024**: ML weather downscaling techniques
- **October 2024**: WUI structure ignition models

### Key Partnerships
- NSF CO-WY ASCEND Engine
...
<div style="text-align: center; margin-top: 3rem;">
    <a href="part-01-orientation/welcome/" class="md-button md-button--primary">Get Started</a>
    <a href="https://github.com/RallypointOne/wildfire-resource-directory-2" class="md-button">View on GitHub</a>
    <a href="part-12-case-studies/resources/" class="md-button">Resources</a>
</div>

*A key deliverable for the NSF CO-WY ASCEND Engine Applied R&D Program*
